# PowerShell Test Script for Amington Hall Staff Itinerary
...
try {
    ...
    Write-Host "`nTest submission sent successfully!" -ForegroundColor Green
    Write-Host "Response: $($response | ConvertTo-Json)" -ForegroundColor Cyan
} catch {
    Write-Host "`nError sending test submission:" -ForegroundColor Red
