      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-xl font-bold text-white">Amington Hall</span>
            </div>
            <p className="text-gray-400 max-w-md mb-6 leading-relaxed">
              Your trusted partner for business solutions. We help companies of all sizes achieve their goals through innovative services and dedicated support.
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Amington Hall. All rights reserved.
          </p>
